...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex">
      {/* Left Side - Compact Sign-Up Form */}
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-8">
        <div className="w-full max-w-sm">
          ...
          <div className="space-y-3 mb-4">
            ...
            <button 
              onClick={() => window.location.href = 'http://localhost:5001/api/auth/apple'}
              className="w-full flex items-center justify-center py-2.5 px-4 border border-gray-300 rounded-lg bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
            >
      ...
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 items-center justify-center p-8">
        <div className="max-w-md text-center">
          ...
          <h2 className="text-4xl font-bold text-gray-900 mb-4 leading-tight">
            Create Sales-Driving Videos in Minutes
          </h2>
          
          {/* Subtext */}
          <p className="text-lg text-gray-600 mb-8 leading-relaxed">
            Generate AI-powered User Generated Content videos that convert. Scale your brand with authentic, engaging content.
          </p>
